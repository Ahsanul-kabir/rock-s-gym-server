...
client.connect(err => {
    const orderCollection = client.db("GymManagement").collection("orders");
    const reviewCollection = client.db("GymManagement").collection("reviews");
    const serviceCollection = client.db("GymManagement").collection("services");
    const adminCollection = client.db("GymManagement").collection("admins");
